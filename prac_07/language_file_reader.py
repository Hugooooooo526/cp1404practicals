...
def main():
    ...
    for line in in_file:
        ...
        # Add the language we just constructed to the list
    ...
    # Display languages that support pointer arithmetic
...
def using_csv_namedtuple():
    """Language file reader version using both 
    csv module and named tuple."""
